...
var resListarTablaPermisos = function () {
...
var resListarTablaRoles = function () {
    //if (evt.target.readyState == 4 && evt.target.status == 200) {
...
var resListarTablaUsuarios = function () {
    //if (evt.target.readyState == 4 && evt.target.status == 200) {
